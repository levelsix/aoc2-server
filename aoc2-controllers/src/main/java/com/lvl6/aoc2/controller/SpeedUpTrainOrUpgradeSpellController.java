...
import com.lvl6.aoc2.eventprotos.SpeedUpTrainOrUpgradeSpellEventProto.SpeedUpTrainOrUpgradeSpellResponseProto.SpeedUpTrainOrUpgradeSpellStatus;
import com.lvl6.aoc2.eventprotos.SpeedUpTrainOrUpgradeSpellEventProto.SpeedUpTrainOrUpgradeSpellResponseProto.Builder;
import com.lvl6.aoc2.events.RequestEvent;
import com.lvl6.aoc2.events.request.SpeedUpTrainOrUpgradeSpellRequestEvent;
import com.lvl6.aoc2.events.response.SpeedUpTrainOrUpgradeSpellResponseEvent;
...
public class SpeedUpTrainOrUpgradeSpellController extends EventController {
	...
	protected void processRequestEvent(RequestEvent event) throws Exception {
		...
		try {
			...
			Spell s = getUserSpellRetrieveUtils().getSpellCorrespondingToUserSpell(us);;
