...
/*	@Override
	public Set<String> getIndexCreateStatements() {
		Set<String> indexes = new HashSet<String>();
<<<<<<< HEAD
		indexes.add("create index user_equip_user_id_index "+tableName()+" (user_id);");
		indexes.add("create index user_equip_equip_id_index "+tableName()+" (equip_id);");
		indexes.add("create index user_equip_equip_level_index "+tableName()+" (equip_level);");
		indexes.add("create index user_equip_equipped_index "+tableName()+" (equipped);");
=======
